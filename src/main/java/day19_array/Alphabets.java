...
public class Alphabets {
    ...
    public static void main(String[] args) {
        ...
        char[] ascending = new char[26]; // index #s = 0 - 25
        char[] descending = new char[26]; // index #s = 0 - 25

        // because the arrays have the same index #s, we can use the same for loop
        // and just add a 3rd variable to compare
