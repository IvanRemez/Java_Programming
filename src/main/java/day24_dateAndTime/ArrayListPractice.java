    ...
    public static void main(String[] args) {
        ...
        for (Employee each : employees) {
            ...
            if (each.jobTitle.equals("Java Developer")){ // if jobTitle is "Java Developer"
                ...
                System.out.println(each.name); // print name of that employee
            }
        }
        System.out.println("-------------------------------------------------------");
        ...
        System.out.println("Total # of female employees:" + femaleEmployees.size());
        System.out.println("Total # of male employees:" + maleEmployees.size());
