...
public class Car {
    ...
    public Car(String make, String model) {
        //this.make = make;
        // can also just call the previous Constructor:
        this(make); // CHAINS this to the previous Constructor
        this.model = model;
    }

    public Car(String make, String model, int year) {
        this(make, model); // Chains 3rd constructor to the previous 2
        this.year = year;
    }
    ...
    public Car(String make, String model, int year, double price, String color) {
        ...
        // ^^ Chains this Constructor to all previous Constructors
        this.color = color;
    }
