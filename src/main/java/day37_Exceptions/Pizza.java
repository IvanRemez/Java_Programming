...
public class Pizza {
    ...
    public boolean equals(Object obj) {
        ...
        // Downcasting ^^ to Reference Type (Object) which determines which
        // features (variables) can be accessed
...
1. Create a class named Pizza
			...
			Override toString method to print Pizza object info when the object is
			passed in the print statement

			Override equals method that returns true if the pizza object is equal
			to the specified pizza object
