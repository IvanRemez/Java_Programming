...
public class RemoveIfPractice {
    ...
    public static void main(String[] args) {
         ...
         */
        // ^^ using For Each loop (for practice)
        System.out.println(smallDogs);

        smallDogs.removeIf(p -> !p.size.equalsIgnoreCase("small"));
        // use removeIf to remove all size dogs except small dogs
...
1. Give the following array of dogs
        ...
        1.1 Create an arrayList named smallDogs, and add all the dog objects with
        the size of small from the dogs array to smallDogs arrayList
	    ...
	    1.3 Create an arrayList named femaleDogs, and add all the dog objects with
	    the gender of 'F' the dogs array to femaleDogs arrayList
	            Note: DO NOT use any loops
